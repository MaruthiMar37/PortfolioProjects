...
--4. Team Dependancy in winning cause at ICC KnockOuts in terms of runs scored by sachin and ponting
...
-- failing find gaps/going for big hits has made him 7 times being Caughtout.Whereas Sachin has never been dismissed for LBW
-- but same as ponting he also failed to find gaps/going for big hits has made him 5 times being Caughtout and except 
-- (LBW &caughtout),Sachin had been dismised equal number of times in every mode.
...
--By seeing both stats ,Sachin has more runs,avgerage than Ponting..so Sachin is man of ICC Semifinals.
...
--By seeing both stats ,Sachin has more runs,avgerage,strikerate and highestscore than Ponting..so Sachin is man of ICC Semifinals.
...
--           and highest score of 141 runs.
--By seeing both stats ,Ponting has more runs,avgerage than Sachin..so Ponting won  the battle against one on one in ICC Knockouts.
